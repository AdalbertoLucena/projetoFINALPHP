    ...
    <main class="car-page">
        <div class="card">
            ...
            <div class="image-wrap">
                <img class="car-image" src="https://upload.wikimedia.org/wikipedia/commons/e/e3/Volkswagen_Gol_Highline_2023_%2853708009248%29_%28cropped%29.jpg" alt="CARRO">
            </div>
            ...
            <form class="reserve-form" method="post" action="reserva.php">
                <input type="hidden" name="modelo" value="VW Gol 1.0 2022">
